 ...
 * 
 */
@WebServiceClient(name = "booksService", targetNamespace = "http://service/", wsdlLocation = "http://localhost:8180/?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BOOKSSERVICE_QNAME = new QName("http://service/", "booksService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8180/?wsdl");
     ...
     *     returns BooksReader
     */
    @WebEndpoint(name = "BooksReaderPort")
    public BooksReader getBooksReaderPort() {
        return super.getPort(new QName("http://service/", "BooksReaderPort"), BooksReader.class);
    }
     ...
     */
    @WebEndpoint(name = "BooksReaderPort")
    public BooksReader getBooksReaderPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service/", "BooksReaderPort"), BooksReader.class, features);
    }
